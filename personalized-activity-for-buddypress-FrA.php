...
function personalized_activity_for_buddypress_FfA_args( $args ) {
...
add_filter( 'bp_after_has_activities_parse_args', 'personalized_activity_for_buddypress_FfA_args' );
